 ...
 * gateway异常信息转换
 * @author melo、lh
 * @createTime 2020-05-20 14:24:08
 */

@Slf4j
public class RainbowGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public RainbowGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
